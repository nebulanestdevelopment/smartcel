...
<script>
    ...
    var tableAccesorios = '<div class="table-responsive"><table class="table table-bordered" id="table-accesorios" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Precio</th><th>Qty</th><th></th></tr></thead></table></div>';
    var tableAccesoriosAutos = '<div class="table-responsive"><table class="table table-bordered" id="table-accesorios-autos" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Precio</th><th>Qty</th><th></th></tr></thead></table></div>';
    var tableCelulares = '<div class="table-responsive"><table class="table table-bordered" id="table-celulares" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Precio</th><th>Qty</th><th></th></tr></thead></table></div>';
    var tableRepuestos = '<div class="table-responsive"><table class="table table-bordered" id="table-repuestos" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Precio</th><th>Qty</th><th></th></tr></thead></table></div>';
    function clearDiv(){
    ...
    function drawTable($content,$table,$tableName,$tipo){
        ...
        new DataTable('#'+$tableName, {
                        ...
                        ajax: "./index.php?action=inventario-controller&method="+$tipo,
                        columns: [  
                { data: 'codigo' },                
                { data: 'nombre' },
                { data: null,
                ...
                { data: null,
                        render: function(data,type){
                             let render = '<a href="'+data.url+'" type="button" class="btn  btn-success text-white btn-xs" ><use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-history"></use></svg> Historial</a>';
                             return render;
                        }
                }],
                select: {
                ...
                createdRow: (row, data, index) => {
                     row.querySelector(':nth-child(4)').classList.add('text-center');

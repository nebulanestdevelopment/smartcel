...
<div class="container-fluid bg-white">
    <br>
<h4>Items que están con Cantidad 0</h4>
<br>
<br>
<nav>
...
<script>
    ...
    var tableAccesorios = '<div class="table-responsive"><table class="table table-bordered" id="table-accesorios" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Costo</th><th>Precio</th><th>Cantidad</th></tr></thead></table></div>';
    var tableAccesoriosAutos = '<div class="table-responsive"><table class="table table-bordered" id="table-accesorios-autos" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Costo</th><th>Precio</th><th>Cantidad</th></tr></thead></table></div>';
    var tableCelulares = '<div class="table-responsive"><table class="table table-bordered" id="table-celulares" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Costo</th><th>Precio</th><th>Cantidad</th></tr></thead></table></div>';
    var tableRepuestos = '<div class="table-responsive"><table class="table table-bordered" id="table-repuestos" ><thead class="bg-dark text-white"><tr><th>Codigo</th><th>Nombre del Item</th><th>Costo</th><th>Precio</th><th>Cantidad</th></tr></thead></table></div>';
    function clearDiv(){
    ...
    function drawTable($content,$table,$tableName,$tipo){
        ...
        new DataTable('#'+$tableName, {
                        ...
                        ajax: "./index.php?action=inventario-controller&method="+$tipo+"-item-cero",
                        columns: [  
                { data: 'codigo' },                
                { data: 'nombre' },
                { data: null,

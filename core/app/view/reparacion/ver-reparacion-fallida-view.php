...
<div class="card mb-4 mt-1">
    <div class="card-body">
        ...
        <div>
            <a href="./index.php?view=reparacion/historial-fallada">Ver reparaciones fallidas</a>
        </div>
        <hr>
        ...
        <form id="reparacionForm" class="p-4">
          ...
          <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label for="nombre" class="col-sm-3 col-form-label" style="text-align: right;">Nota del fallo de la reparacion</label>
                    <div class="col-sm-5">
...
<?php include('partials-ver-fallida.php');  ?> 

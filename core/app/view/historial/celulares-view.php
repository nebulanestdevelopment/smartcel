...
if($entrada == 0 && $salida == 0){ 
  header('location: ./index.php?view=producto/celulares');
}
...
<div class="card mb-4 mt-1">
    <div class="card-body">
        <h4 class="p-4 pl-0 pb-0" style="padding-left: 10px !important;" id="titles-product-top"></h4><a href="./index.php?view=producto/celulares" class="btn btn-link mb-4">Regresar al inventario de celulares</a>
  <div class="row">
...
function llenarTabla(id){
    var url = './index.php?action=historial/celulares-controller&method=movimientos&id='+id;
    $.ajax({
        method: "GET",
        url: url,
        dataType: "json",
...
function obtenerDatosGenerales(id){
    var url = "./index.php?action=producto/celulares-controller&method=edit&id="+id;
    $.ajax({
        method: "GET",
        url: url,
        dataType: "json",
        success: function(data){
          ...
          var $title = data.marca+' '+data.modelo+' '+data.color+' '+data.categoria;
...
function eliminarRecord(oid,pid){
  if (confirm('Esta seguro que desea eliminar este registro!!!') == true) {
      ...
      request = $.ajax({
          url: "./index.php?action=historial/celulares-controller",
          type: "post",

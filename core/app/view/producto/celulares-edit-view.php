...
<form id="celularesInvForm">
          <input type="hidden" name="idCelularInv" id="idCelularInv">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-8">
               <textarea class="form-control" id="justificacion" name="justificacion" placeholder="Justifique porque aumenta o decrementa el inventario de este celular" rows="2"></textarea>
            </div>
          </div> 
          <div class="row mt-3">
            <div class="col-3">
            ...
            <div class="col-6">
              ...
              <button type="button" class="btn btn-secundary" onclick="window.location.href='./index.php?view=producto/celulares';"> Ver inventario de celulares</button>
...
<div class="container-fluid bg-white p-5" style="border-radius: 25px;">
<h6><span id="title-page"></span> | editar informacion del celular</h6>
<hr>
</br>

<form id="ClienteForm">
<input type="hidden" name="idCelular" id="idCelular">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-8">
               <input type="text" class="form-control" id="imei1" name="imei1" placeholder="CODIGO IMEI #1" >
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-8">
               <input type="text" class="form-control" id="imei2" name="imei2" placeholder="CODIGO IMEI #2" >
            </div>
          </div>  
          <div class="row mb-3">
            <label for="nombre" class="col-sm-3 col-form-label" style="text-align: right;">Marca</label>
            <div class="col-sm-8">
               <input type="text" class="form-control" id="marca" name="marca" placeholder="Marca del celular" >
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-8">
               <input type="text" class="form-control" id="color" name="color" placeholder="Color del celular" >
            </div>
          </div>
          ...
          <div class="row mb-3"> 
            <label for="nombre" class="col-sm-3 col-form-label" style="text-align: right;">Inventario Existente</label>
            <div class="col-sm-6">
               <input type="number" class="form-control" id="invini" name="invini" value="0" min="0" max="1000" disabled>
            </div>
          </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6">
              ...
              <button type="button" class="btn btn-success" onclick="duplicarProducto()"> Duplicar Celular</button>
              <button type="button" class="btn btn-secundary" onclick="window.location.href='./index.php?view=producto/celulares';"> Ver inventario de celulares</button>
...
function crearCategoria(){
  ...
  $('#cat-name').val("");
  $('#subcategoria').val("CELULARES").change();
  $('#idCategoria').val(0);
...
function guardarNuevaCategoria(){  
        ...
        var dataForm = {method:'save-return',nombre:$("#cat-name").val().trim(),subcategoria:'CELULARES'};
        var request;
...
function duplicarProducto(){
  var dataForm = {method:'duplicar-producto',
                        id:parseInt($("#idCelular").val().trim())
                        };
        var request;        
        if (request) {
            request.abort();
        ...
        request = $.ajax({
            url: "./index.php?action=producto/celulares-controller",
            type: "POST",
            data: dataForm
        });
        request.done(function (data, textStatus, jqXHR){
          toastr.success(data.msg, 'Exitoso', {timeOut: 3000});
          setTimeout(function(){window.location.href= './index.php?view=producto/celulares-edit&id='+data.id ;},2500);
...
function actualizarInventario(){
  ...
  var dataForm = {method:'update-inventario',
                        id:parseInt($("#idCelularInv").val().trim()),
...
$("#ClienteForm").submit(function(event) {
  ...
  formData.append("id", parseInt($("#idCelular").val()));
  ...
  formData.append("imei1", $("#imei1").val().trim());
  formData.append("imei2", $("#imei2").val().trim());  
...
$(document).ready(function(){
  const urlParams = new URLSearchParams(window.location.search);
    ...
    $("#idCelular").val(id);
    $("#idCelularInv").val(id);
    $.getJSON('./index.php?action=producto/celulares-controller&method=edit&id='+id, function(v) {
      getAllCategory(v.categoria,v.categoriaid);
      getAllProveedores(v.proveedor,v.proveedorid);
      const $title =  v.marca+' '+v.modelo+' '+v.color+' '+v.categoria;   

...
if(isset($_POST['query'])){
    $data = ComprasData::getProducts($_POST['query'],'',1);
?>
<h4>Resultados de la Busqueda para Accesorios</h4>
            ...
            foreach ($data as $i => $v) {
               ...
               if(intval($v['unidades']) > 0){
                    echo '  
                                    ...
                                    <td><button class="btn btn-primary" onclick="agregarAccesorioToCart('.$i.')">Agregar</button></td>

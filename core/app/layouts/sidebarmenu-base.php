<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <li class="nav-item"><a class="nav-link" href="./index.php?view=home">
              <svg class="nav-icon">
                <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-house"></use>
              </svg> INICIO</a>
          </li>
        <?php if(Roles::hasSeller() || Roles::hasAdmin() ){ ?>      
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="./index.php?view=producto/accesorios" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-screen-smartphone"></use>
                </svg> Accesorios</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=producto/accesorios-autos" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-car-alt"></use>
                </svg> Accesorios de Autos</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=producto/celulares" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-screen-smartphone"></use>
                </svg> Celulares</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=producto/repuestos" target="_top">
                <svg class="nav-icon">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            </svg> Historial de Productos</a>
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="./index.php?view=historial/productos" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-money"></use>
                </svg> Historial de precios</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=historial/productos-eliminados" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-trash"></use>
                </svg> Productos eliminados</a></li>
          </ul>
        </li>
        <?php } ?> 
        <?php if(Roles::hasAdmin()){ ?>   
          <li class="nav-item"><a class="nav-link" href="./index.php?view=categoria">
              <svg class="nav-icon">
      ...
      <?php if(Roles::hasSeller() || Roles::hasAdmin()){ ?>   
        ...
        <li class="nav-title">Movimientos</li>
          <li class="nav-item"><a class="nav-link" href="./index.php?view=facturar/facturar">
              <svg class="nav-icon">
                <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-money"></use>
              </svg> Facturar</a>
          </li>
      ...
      <?php if(Roles::hasAdmin() ){ ?>      
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-arrow-thick-from-left"></use>
            </svg> Compras</a>
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="./index.php?view=compras/nueva" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-playlist-add"></use>
                </svg> Nueva compra</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=compras/historial" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-history"></use>
        ...
        <li class="nav-item"><a class="nav-link" href="./index.php?view=ventas/historial">
              <svg class="nav-icon">
                <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-cart"></use>
              </svg> Ventas</a>
          </li>

          <li class="nav-item"><a class="nav-link" href="./index.php?view=caja/historial">
              <svg class="nav-icon">
      ...
      <?php if(Roles::hasSeller() || Roles::hasAdmin() ){ ?>  
       <li class="nav-divider"></li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="./index.php?view=egreso/mensual" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-chart-line"></use>
                </svg> Pagos Mes Actual</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=egreso/tipo" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-list"></use>
                </svg> Tipos de pagos</a></li>
            
            <li class="nav-item"><a class="nav-link" href="./index.php?view=egreso/historial" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-chart-line"></use>
                </svg> Historial de pagos</a></li>
          </ul>
        </li>
        <?php } ?> 
        <?php if(Roles::hasRepairMan() ){ ?>  
          <li class="nav-item"><a class="nav-link" href="./index.php?view=repairman/home">
            <svg class="nav-icon">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="./index.php?view=reparacion/nueva" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-plus"></use>
                </svg> Nueva Reparacion</a></li>
                <li class="nav-item"><a class="nav-link" href="./index.php?view=reparacion/abiertas" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-bolt-circle"></use>
                </svg> Reparaciones abiertas</a></li>
                
                
            <li class="nav-item"><a class="nav-link" href="./index.php?view=reparacion/historial" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-list"></use>
                </svg> Historial de reparaciones</a></li>
            
            <li class="nav-item"><a class="nav-link" href="./index.php?view=reparacion/historial-fallada" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-chart-line"></use>
                </svg> Reparaciones falladas</a></li>
          </ul>
        </li>
        <?php } ?> 
        ...
        <li class="nav-item"><a class="nav-link" href="./index.php?view=cliente/cliente">
            <svg class="nav-icon">
              <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-arrow-circle-right"></use>
            </svg> Clientes</a>
        </li>  
        <li class="nav-item"><a class="nav-link" href="./index.php?view=cliente/proveedor">
            <svg class="nav-icon">
              <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-arrow-circle-right"></use>
            </svg> Proveedores</a>
        </li>  
        <?php } ?> 
        <?php if(Roles::hasAdmin()){ ?>   
        <li class="nav-item"><a class="nav-link" href="./index.php?view=usuario">
            <svg class="nav-icon">
        ...
        <?php if(Roles::hasAdmin()){ ?>   
        <li class="nav-divider"></li>
        <li class="nav-title">Estadisticas</li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-bar-chart"></use>
            </svg> Reportes</a>
          <ul class="nav-group-items">
          <li class="nav-item"><a class="nav-link" href="./index.php?view=reportes/ventas" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-chart"></use>
                </svg> Ventas</a></li>
                <li class="nav-item"><a class="nav-link" href="./index.php?view=reportes/ganancias" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-chart"></use>
                </svg> Ganancias</a></li>
            <li class="nav-item"><a class="nav-link" href="./index.php?view=reportes/inventario" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="./vendors/@coreui/icons/svg/free.svg#cil-chart"></use>
                </svg> Inventario</a></li>
          </ul>
